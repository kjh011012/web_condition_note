...
export const villages = [
  {
    ...
    tags: ["숲 치유", "싱잉볼", "족욕"],
    inclusions: ["약선음식 3끼", "건강체조", "숲길 산책", "명상", "족욕 + 찜질", "스트레스 측정", "싱잉볼"],
    exclusions: ["개인 교통", "개인 간식", "개인 세면도구 일부", "개인 추가 구매 항목"],
    accommodation: {
      type: "2인실 / 가족실",
      amenities: ["개별 화장실", "냉난방 완비", "침대형 침구"],
      note: "숙소는 화려하기보다 조용히 쉬어가기 좋은 분위기로 정돈되어 있습니다.",
    },
    meals: {
      summary: "약선식 3끼 제공, 강원 지역 식재료 활용, 자극적이지 않고 편안한 구성",
      note: "식사는 과하지 않게, 몸이 편안해지는 따뜻한 구성으로 준비됩니다.",
    },
    address: "강원특별자치도 횡성군 청일면 봉명로 375-1",
    phone: "010-9435-0053",
    checkin: "14:00",
    checkout: "11:00",
    parking: true,
    preparations: ["편한 복장", "산책 가능한 신발", "계절별 겉옷", "개인 상비약"],
    itinerary: [
      {
        day: "D1",
        label: "Day 1",
        steps: [
          { time: "12:00", title: "점심 약선음식", body: "강원의 식재료로 가볍고 따뜻하게 시작하는 첫 식사" },
          { time: "14:00", title: "건강체조", body: "몸을 부드럽게 풀어주는 가벼운 움직임" },
          { time: "15:00", title: "숲길 산책", body: "무리하지 않는 동선으로 천천히 걷는 시간" },
          { time: "16:30", title: "명상", body: "숲의 소리를 들으며 고요히 쉬어가는 시간" },
          { time: "18:00", title: "저녁 약선식", body: "몸에 편안한 저녁 한 상" },
          { time: "19:30", title: "족욕 + 찜질", body: "하루의 긴장을 부드럽게 풀어주는 저녁 프로그램" },
          { time: "20:30", title: "스트레스 측정", body: "간단한 상태 체크로 하루를 마무리" },
        ],
      },
      {
        day: "D2",
        label: "Day 2",
        steps: [
          { time: "08:00", title: "아침 약선식", body: "제철 재료로 차린 가벼운 아침" },
          { time: "09:30", title: "싱잉볼 명상", body: "소리 진동으로 마음을 고요히 정리하는 시간" },
          { time: "10:30", title: "자유 산책", body: "자신의 속도로 마을 주변을 거닐며 여운을 남깁니다" },
          { time: "11:00", title: "체크아웃", body: "정리 후 출발" },
        ],
      },
    ],
    reassurance: [
    ...
    reviews: [
      ...
      { author: "이정민", body: "싱잉볼 소리가 정말 인상 깊었고 밤 공기도 너무 좋았습니다." },
    ],
    bookingOptions: {
  ...
  },
  {
    ...
    tags: ["아로마", "황토찜질", "힐링식"],
    inclusions: ["숙박", "아로마 브레인 디톡스", "족욕", "황토찜질", "더덕 허브 바비큐", "아침 식사"],
    exclusions: ["개인 교통", "개인 간식", "주류"],
    accommodation: {
      type: "황토방 / 온돌실",
      amenities: ["황토 바닥 온돌", "개별 화장실", "냉난방 완비"],
      note: "황토의 원적외선 효과로 숙면을 돕는 환경입니다.",
    },
    meals: {
      summary: "더덕 허브 바비큐 저녁, 제철 식재료 아침 제공",
      note: "강원 지역 약선 재료를 활용한 자극적이지 않은 구성입니다.",
    },
    address: "강원특별자치도 횡성군 청일면 춘당로 232",
    phone: "010-4150-1952",
    checkin: "13:30",
    checkout: "11:00",
    parking: true,
    preparations: ["편한 복장", "세면도구", "개인 상비약", "수건(일부 제공)"],
    itinerary: [
      {
        day: "D1",
        label: "Day 1",
        steps: [
          { time: "13:30", title: "입실 및 웰컴 티", body: "허브 차와 함께 여정 안내를 받습니다." },
          { time: "14:30", title: "아로마 브레인 디톡스", body: "아로마 향으로 두뇌 긴장을 부드럽게 이완합니다." },
          { time: "16:00", title: "아로마 족욕", body: "발부터 전신으로 이어지는 온열 이완 시간" },
          { time: "18:30", title: "더덕 허브 훈제 바비큐", body: "지역 더덕과 허브로 만든 저녁 식사" },
          { time: "20:00", title: "황토찜질", body: "온열로 몸의 피로를 깊게 풀어주는 저녁 프로그램" },
        ],
      },
      {
        day: "D2",
        label: "Day 2",
        steps: [
          { time: "08:00", title: "제철 아침 식사", body: "가볍고 따뜻한 한식 아침" },
          { time: "09:30", title: "마을 산책", body: "아침 공기를 마시며 마을 주변을 자유롭게 걷습니다." },
          { time: "11:00", title: "체크아웃", body: "여운을 안고 출발합니다." },
        ],
      },
    ],
    reassurance: [
    ...
    reviews: [
      ...
      { author: "박준서", body: "아로마 족욕이 생각보다 훨씬 효과적이었어요. 어깨가 많이 내려갔습니다." },
    ],
    bookingOptions: {
  ...
  },
  {
    ...
    tags: ["약선식", "기공", "산책"],
    inclusions: ["숙박", "약선 식탁 3끼", "선도기공 세션", "치유 산책", "측정 연계"],
    exclusions: ["개인 교통", "주류", "개인 추가 구매"],
    accommodation: {
      type: "2인실 / 가족실",
      amenities: ["개별 화장실", "냉난방 완비", "침대형 침구"],
      note: "태기산 자락의 조용한 숙소로, 창밖으로 산세를 감상할 수 있습니다.",
    },
    meals: {
      summary: "더덕무침·토마토김치 등 약선 3끼 제공, 강원 지역 식재료 활용",
      note: "자극적이지 않은 약선 식탁으로 소화 부담 없이 편안하게 드실 수 있습니다.",
    },
    address: "강원특별자치도 횡성군 청일면 청일로 779번길 117",
    phone: "010-6847-8713",
    checkin: "13:00",
    checkout: "11:30",
    parking: true,
    ...
    itinerary: [
      {
        ...
        label: "Day 1",
        steps: [
          { time: "13:00", title: "입실 및 웰컴 티", body: "전통 허브 차와 함께 일정을 안내 받습니다." },
          { time: "14:00", title: "국자랑 선도기공", body: "호흡과 몸의 기운을 정렬하는 전통 기공 수련" },
          { time: "16:00", title: "치유 산책", body: "태기산 자락 숲길을 천천히 걷습니다." },
          { time: "18:00", title: "저녁 약선 식탁", body: "더덕무침·토마토김치 등 한 상 가득 차린 저녁" },
          { time: "20:00", title: "명상 & 자유 시간", body: "조용히 하루를 정리하는 시간" },
        ],
      },
      {
        day: "D2",
        label: "Day 2",
        steps: [
          { time: "07:30", title: "아침 기공", body: "가벼운 스트레칭과 호흡으로 하루를 엽니다." },
          { time: "08:30", title: "아침 약선 식사", body: "제철 나물과 함께한 정갈한 아침 한 상" },
          { time: "10:00", title: "자유 시간 & 산책", body: "마을 주변을 자신의 속도로 거닙니다." },
          { time: "11:30", title: "체크아웃", body: "여운을 안고 출발합니다." },
        ],
      },
    ],
    reassurance: [
    ...
    reviews: [
      ...
      { author: "김영희", body: "기공 세션이 처음이었는데 강사님이 친절하게 안내해 주셔서 좋았어요." },
    ],
    bookingOptions: {
...
export const farms = [
  {
    ...
    description:
      "숲슐랭 피크닉·샐러드 피크닉 도시락·초록쉼표 치유여행. 자연 속에서 도시락을 펼치고 숲의 소리에 귀를 기울이는 치유 여정입니다.",
    tags: ["숲 피크닉", "도시락", "치유여행"],
    inclusions: ["숲슐랭 피크닉 도시락", "초록쉼표 치유 프로그램", "음료", "현장 안내"],
    exclusions: ["개인 교통", "개인 간식", "우천 시 우비"],
    address: "강원특별자치도 횡성군 갑천면 외갑천로 694번길 92-20",
    phone: "010-9040-5295",
    parking: true,
    preparations: ["편한 복장", "운동화 또는 트레킹화", "자외선 차단제", "개인 물통"],
    flow: [
    ...
    reviews: [
      ...
      { author: "최지수", body: "숲길 걸으며 도시락 먹는 경험이 처음이었는데 정말 힐링됐습니다." },
    ],
    bookingOptions: {
  ...
  },
  {
    ...
    description:
      "애완닭·앵무새 등과의 동물 교감 프로그램. 아이와 함께 동물의 따뜻한 체온을 느끼며 자연스러운 감성 치유를 경험합니다.",
    tags: ["동물교감", "가족", "농장"],
    inclusions: ["동물 교감 프로그램", "먹이주기 체험", "간식", "현장 안내"],
    exclusions: ["개인 교통", "개인 간식", "사진 인화"],
    address: "강원특별자치도 횡성군 공근면 금계로 11-13",
    phone: "010-9743-0078",
    parking: true,
    preparations: ["편한 복장", "운동화", "여벌 옷(아이용 권장)", "손 소독제"],
    flow: [
    ...
    reviews: [
      ...
      { author: "김민준", body: "앵무새와 교감하는 시간이 가장 인상 깊었습니다." },
    ],
    bookingOptions: {
  ...
  },
  {
    ...
    description:
      "텃밭에서 직접 수확한 재료로 만드는 브런치와 야외 피크닉, 그리고 원격근무 가능한 치유 공간까지. 일과 쉼의 경계를 자연 속에서 재설정합니다.",
    tags: ["브런치", "피크닉", "워케이션"],
    inclusions: ["텃밭 수확 체험", "브런치 1회", "음료", "워크스페이스 이용"],
    exclusions: ["개인 교통", "추가 식사", "와이파이 외 인터넷 장비"],
    address: "강원특별자치도 횡성군 둔내면 삽교로 386",
    phone: "010-9219-4922",
    parking: true,
    preparations: ["편한 복장", "노트북(워케이션 이용 시)", "개인 텀블러", "선크림"],
    flow: [
    ...
    reviews: [
      ...
      { author: "이수아", body: "직접 수확한 채소로 만든 브런치라 더 맛있게 느껴졌어요." },
    ],
    bookingOptions: {
